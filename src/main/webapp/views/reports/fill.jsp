...
<head>
    ...
    <title>Заполнение отчета - Power Grid Management</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1>📝 Заполнение отчета</h1>
        <div>
            <% if (planId != null) { %>
            <a href="${pageContext.request.contextPath}/plans?action=view&id=<%= planId %>" class="btn btn-secondary">
                ← К плану
            </a>
            <% } %>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0">
                <%= report.getTitle() %>
                <span class="badge bg-primary">Заполнение</span>
            </h5>
        </div>
        <div class="card-body">
            <form action="${pageContext.request.contextPath}/reports" method="post">
                ...
                <div class="alert alert-info">
                    ...
                    <ul class="mb-0">
                        <li>Квартальный план показан с нарастающим итогом</li>
                        <li>Накопленный факт рассчитывается автоматически</li>
                        <li>Проценты выполнения обновляются после сохранения</li>
                    </ul>
                </div>
